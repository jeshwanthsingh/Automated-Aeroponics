...
try:
        while True:
                ...
                if(shootTemp>22):
                        ...
                        data="Your Green House state is Ubnormal, High Temperature"         # If Shoot temperature is greater than
                        GPIO.output(motor,False)                                            # threshold, turn on Fan
                        print("Fan On")
                        print("Sending e-Mail")
                        subprocess.call(["sudo","python","mail.py",Sensordata,data])        # and send email
                        print("Mail Sent")
                else:
